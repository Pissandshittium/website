...
export default function ThemeSwitcher() {
  ...
  return (
    <>
    <motion.div initial={{right:-192}} animate={{right:48}} transition={{duration:0.5}} className="fixed bottom-12 lg:top-12 right-12 lg:bottom-auto backdrop-blur-sm invert backdrop-brightness-110  bg-transparent px-8 py-4 rounded-xl shadow-xl">
